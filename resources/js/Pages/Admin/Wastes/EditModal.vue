...
// Mengisi data awal form dari record yang dikirim komponen utama
const form = useForm({
    name: props.waste.name,
    unit: props.waste.unit,
    current_price: props.waste.current_price,
    description: props.waste.description,
});

const submit = () => {
    form.put(route("admin.wastes.update", props.waste.id), {
